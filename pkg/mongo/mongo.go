...
func Init() {
	...
	clientOptions := options.Client().ApplyURI("mongodb://" +
		configs.ConfigData.Mongodb.Host +
		":" +
		configs.ConfigData.Mongodb.Port)
	...
	FactoryInfoColl = mgo.Database(configs.ConfigData.Mongodb.Database).Collection(FACTORY_INFO_COLL)
	FactoryDataColl = mgo.Database(configs.ConfigData.Mongodb.Database).Collection(FACTORY_DATA_COLL)
	FactoryDataCountColl = mgo.Database(configs.ConfigData.Mongodb.Database).Collection(FACTORY_DATA_COUNT_COLL)
}
